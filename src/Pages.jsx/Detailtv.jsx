...
function Detailtv() {
  ...
  return (
    <div className='bg-black overflow-hidden'>
      ...
      >
        <div className="w-screen h-full bg-gradient-to-r from-black to-transparent pl-8 pt-96 pr-52">
        <div className='ml-14'>
          <h1 className="text-6xl font-thin text-white mb-4">{movies.name}</h1>
    ...
    <button className="bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded">
      Add to Favorites
        ...
        <div className='mx-16'>
            <p className='text-2xl pl-5 pt-5 text-white'>More shows like this</p>
